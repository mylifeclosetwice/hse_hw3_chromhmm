...
3 | | Появляется преимущественно в | Для состояния характерна метка H3k4me1 , менее характерна метка H3k27ac
4 | | Появляется преимущественно в | Для состояния характерны метки H3k4me1, H2AFZ, H3k27ac, H3k9ac и H3k4me2
