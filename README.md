...
2 | | | Для состояния характерна метка: H3K79me2 и H3k4me1, менее характерны метки H4K20me1, H3k27ac, H3k9ac и H3k4me2
3 | | | Для состояния характерна метка: H3k4me1 , менее характерна метка H3k27ac
4 | | | Для состояния характерна метка: H3k4me1, H2AFZ, H3k27ac, H3k9ac и H3k4me2
5 | | | Для состояния характерна метка:
6 | | | Для состояния характерна метка: H3K79me2
7 | | | Для состояния характерна метка:
8 | | | Для состояния характерна метка:
9 | | | Для состояния характерна метка:
10 | | | Для состояния характерна метка:
